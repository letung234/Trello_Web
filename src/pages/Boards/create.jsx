      ...
      >
        <Box sx={{
          ...
          <Box id="modal-modal-title" sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <LibraryAddIcon />
            <Typography variant="h6" component="h2"> Tạo 1 bảng mới</Typography>
          </Box>
                ...
                <Box>
                  <TextField
                    ...
                    {...register('title', {
                      ...
                      minLength: { value: 3, message: 'Phải nhập ít nhất 3 ký tự' },
                      maxLength: { value: 50, message: 'không nhập quá 50 ký tự' }
                    })}
                    error={!!errors['title']}
                  />
                ...
                <Box>
                  <TextField
                    ...
                    {...register('description', {
                      required: FIELD_REQUIRED_MESSAGE,
                      minLength: { value: 3, message: 'Phải nhập ít nhất 3 ký tự' },
                      maxLength: { value: 255, message: 'không nhập quá 50 ký tự' }
                    })}
