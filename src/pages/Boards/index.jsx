...
function Boards() {
  ...
  const afterCreateNewBoard = () => {
    // Fetch lại danh sách board tương tự useEffect
    fetchBoardsAPI(location.search).then(updateStateData)
  }

  // Lúc chưa tồn tại boards > đang chờ gọi api thì hiện loading
  if (!boards) {
    return <PageLoadingSpinner caption="Đang tải bảng..."/>
  }
      ...
      <Box sx={{ paddingX: 2, my: 4 }}>
        <Grid container spacing={2}>
          ...
          <Grid xs={12} sm={9}>
            ...
            {boards?.length === 0 &&
              <Typography variant="span" sx={{ fontWeight: 'bold', mb: 3 }}>Khômg tìm thấy bảng nào!</Typography>
            }
                    ...
                    <Card sx={{ width: '250px' }}>
                      ...
                      <CardContent sx={{ p: 1.5, '&:last-child': { p: 1.5 } }}>
                        ...
                        <Box
                          ...
                          Đi tới bảng <ArrowRightIcon fontSize="small" />
                        </Box>
                      </CardContent>
                    </Card>
                  </Grid>
